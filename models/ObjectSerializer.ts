...
let enumsMap: Set<string> = new Set<string>([
    "VerifyApiKeyResponseStatusEnum",
]);
...
let typeMap: {[index: string]: any} = {
    ...
    "RetrieveApiKeyByIdResponse": RetrieveApiKeyByIdResponse,
    "RetrieveApiKeysResponse": RetrieveApiKeysResponse,
    "RetrieveWorkspaceByIdResponse": RetrieveWorkspaceByIdResponse,
